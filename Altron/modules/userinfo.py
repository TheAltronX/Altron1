...
from Altron.__main__ import STATS, TOKEN, USER_INFO
import Altron.modules.sql.userinfo_sql as sql
...
from Altron.modules.sql.afk_sql import is_afk, check_afk_status
