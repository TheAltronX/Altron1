...
ELEVATED_USERS_FILE = os.path.join(os.getcwd(), "Altron/elevated_users.json")
...
def sudolist(update: Update, context: CallbackContext):
    ...
    true_sudo = list(set(PYTHON) - set(DEV_USERS))
...
*List all special users:*
 ❍ /dragon*:* Lists all Dragon disasters
...
SUDOLIST_HANDLER = CommandHandler(["sudolist", "PYTHON"], sudolist)
