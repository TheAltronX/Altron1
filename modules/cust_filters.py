...
from Altron import dispatcher, LOGGER, PYTHON
from Altron.modules.disable import DisableAbleCommandHandler
from Altron.modules.helper_funcs.handlers import MessageHandlerChecker
from Altron.modules.helper_funcs.chat_status import user_admin
from Altron.modules.helper_funcs.extraction import extract_text
from Altron.modules.helper_funcs.filters import CustomFilters
from Altron.modules.helper_funcs.misc import build_keyboard_parser
from Altron.modules.helper_funcs.msg_types import get_filter_type
from Altron.modules.helper_funcs.string_handling import (
    split_quotes,
    button_markdown_parser,
    escape_invalid_curly_brackets,
    markdown_to_html,
)
from Altron.modules.sql import cust_filters_sql as sql

from Altron.modules.connection import connected

from Altron.modules.helper_funcs.alternate import send_message, typing_action
...
def rmall_filters(update, context):
    ...
    if member.status != "creator" and user.id not in PYTHON:
...
def rmall_callback(update, context):
    ...
    if query.data == "filters_rmall":
        if member.status == "creator" or query.from_user.id in PYTHON:
